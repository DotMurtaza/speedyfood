...
import 'package:speedy_food/Views/SuccessPage/success_page.dart';
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            CustomInputField(
              hint: "i.e Nabeel Ahmad",
              controller: emailController,
              inputType: TextInputType.emailAddress,
            ),
            const HeightBox(height: 2),
            const LabelWidget(label: "Contact no#"),
            CustomInputField(
              hint: "i.e +923054434567",
              controller: emailController,
